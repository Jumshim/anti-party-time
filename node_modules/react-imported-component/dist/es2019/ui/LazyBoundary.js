...
const LazyServerBoundary = ({ children }) => React.createElement(React.Fragment, null, children);
const LazyClientBoundary = ({ children, fallback }) => (React.createElement(React.Suspense
