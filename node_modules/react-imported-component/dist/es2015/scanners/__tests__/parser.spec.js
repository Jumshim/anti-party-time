...
describe('scanForImports', function () {
    var rel = dirname(__dirname);
    var root = '.';
    var rootRel = '.' + process.cwd();
    var sourceFile = rel + "/a";
    it('should map simple import', function () {
        var imports = {};
        remapImports([{ file: rel + "/a", content: 'blabla;import("./b.js"); blabla;' }], rel, rel, getRelative, imports, function () { return true; });
    ...
    it('handles imports in jsdoc', function () {
        ...
        ], rel, rel, getRelative, imports, function () { return true; });
    ...
    it('should map client-side import', function () {
        var imports = {};
        remapImports([{ file: sourceFile, content: 'blabla;import(/* client-side */"./a.js"); blabla;' }], rel, rel, getRelative, imports, function () { return true; });
        expect(Object.values(imports)).toEqual([
    ...
    it('should map simple import with a comment', function () {
        var imports = {};
        remapImports([{ file: sourceFile, content: 'blabla;import(/* comment:42 */"./a.js"); blabla;' }], rel, rel, getRelative, imports, function () { return true; });
        expect(Object.values(imports)).toEqual([
